...
const Menu = ({isMenuOpen,setIsMenuOpen,}) => {
  ...
  return (
    <div className={` ${styles.menu} ${isMenuOpen ? styles.menuOpen : styles.menuClose}`}>
        <div className='logo absolute italiana'>
            <p className='text-9xl p-10'>TIE</p>
        </div>
        <div className='absolute arial right-5 lg:right-20 top-10 text-white text-opacity-50 text-3xl p-5 cursor-pointer hover:text-white' onClick={() => setIsMenuOpen(false)}>CLOSE</div>
